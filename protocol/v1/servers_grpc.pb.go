...
type ServersClient interface {
	...
	List(ctx context.Context, in *ListFilter, opts ...grpc.CallOption) (*PaginatedServers, error)
...
func (c *serversClient) List(ctx context.Context, in *ListFilter, opts ...grpc.CallOption) (*PaginatedServers, error) {
	out := new(PaginatedServers)
	err := c.cc.Invoke(ctx, "/me.vniche.collective.v1.Servers/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serversClient) Watch(ctx context.Context, in *ResourceIdentity, opts ...grpc.CallOption) (Servers_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Servers_ServiceDesc.Streams[0], "/me.vniche.collective.v1.Servers/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
type ServersServer interface {
	...
	List(context.Context, *ListFilter) (*PaginatedServers, error)
...
func (UnimplementedServersServer) List(context.Context, *ListFilter) (*PaginatedServers, error) {
...
func _Servers_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListFilter)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServersServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/me.vniche.collective.v1.Servers/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServersServer).List(ctx, req.(*ListFilter))
	}
	return interceptor(ctx, in, info, handler)
}
